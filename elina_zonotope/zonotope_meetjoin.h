...
/* 2.Join */
zonotope_t *zonotope_join(elina_manager_t *man, bool destructive,
                          zonotope_t *z1, zonotope_t *z2);
zonotope_t *zonotope_join_array(elina_manager_t *man, zonotope_t **tab,
                                size_t size);
