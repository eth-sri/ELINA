...
__global__ void
copy_coeffs_and_csts(float_type *__restrict__ target_coeff,
                     float_type *__restrict__ target_cst,
...
void update_state_using_previous_layers(elina_manager_t *man, fppoly_t *fp,
  ...
  copy_coeffs_and_csts<<<num_out_neurons_last_layer, 1>>>(
      linf_coeff, linf_cst, coeffs, csts, num_out_neurons_last_layer,
      num_in_neurons_last_layer);
  copy_coeffs_and_csts<<<num_out_neurons_last_layer, 1>>>(
      lsup_coeff, lsup_cst, coeffs, csts, num_out_neurons_last_layer,
      num_in_neurons_last_layer);
  copy_coeffs_and_csts<<<num_out_neurons_last_layer, 1>>>(
      uinf_coeff, uinf_cst, coeffs, csts, num_out_neurons_last_layer,
      num_in_neurons_last_layer);
  copy_coeffs_and_csts<<<num_out_neurons_last_layer, 1>>>(
      usup_coeff, usup_cst, coeffs, csts, num_out_neurons_last_layer,
      num_in_neurons_last_layer);
...
void update_state_using_previous_layers_conv_chunk(
  ...
  while (k >= 0) {
    update_state_using_predecessor_layer_conv_chunk(
        ...
        x_y_size_last_layer, num_filters_last_layer, num_chunks);
