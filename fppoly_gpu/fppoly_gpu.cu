...
void layer_create_sparse_exprs(
    fppoly_t *const fp, const float_type *filter_weights,
    const float_type *filter_bias, const size_t *input_size,
    const size_t *filter_size, const size_t num_filters, const size_t *strides,
    const size_t *output_size, const size_t pad_top, const size_t pad_left,
    const bool has_bias, const activation_type_t activation) {
...
void conv_handle_first_layer(elina_manager_t *man, elina_abstract0_t *element,
  ...
  layer_create_sparse_exprs(fp, filter_weights, filter_bias, input_size,
                            filter_size, num_filters, strides, output_size,
                            pad_top, pad_left, has_bias, RELU);
...
void conv_handle_intermediate_layer(
  ...
  layer_create_sparse_exprs(fp, filter_weights, filter_bias, input_size,
                            filter_size, num_filters, strides, output_size,
                            pad_top, pad_left, has_bias, activation);
