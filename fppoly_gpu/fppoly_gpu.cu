...
void update_state_using_previous_layers_conv(elina_manager_t *man, fppoly_t *fp,
  ...
  const long int mat_min_min_0 = x_min_0 * fp->layers[layerno]->input_size[1] *
                                     fp->layers[layerno]->input_size[2] +
                                 y_min_0 * fp->layers[layerno]->input_size[2];
  const long int mat_min_max_0 = x_min_0 * fp->layers[layerno]->input_size[1] *
                                     fp->layers[layerno]->input_size[2] +
  ...
  const long int mat_min_min_1 = x_min_1 * fp->layers[layerno]->input_size[1] *
                                     fp->layers[layerno]->input_size[2] +
                                 y_min_1 * fp->layers[layerno]->input_size[2];
  const long int mat_min_max_1 = x_min_1 * fp->layers[layerno]->input_size[1] *
                                     fp->layers[layerno]->input_size[2] +
  ...
  for (int k = layerno - 1; k >= 0; k--) {
    ...
    const long int mat_min_min_0 =
        x_min_0 * fp->layers[k]->input_size[1] * fp->layers[k]->input_size[2] +
        y_min_0 * fp->layers[k]->input_size[2];
    const long int mat_min_max_0 =
        x_min_0 * fp->layers[k]->input_size[1] * fp->layers[k]->input_size[2] +
    ...
    const long int mat_min_min_1 =
        x_min_1 * fp->layers[k]->input_size[1] * fp->layers[k]->input_size[2] +
        y_min_1 * fp->layers[k]->input_size[2];
    const long int mat_min_max_1 =
        x_min_1 * fp->layers[k]->input_size[1] * fp->layers[k]->input_size[2] +
