...
__device__
void interval_mul(float_type& a_inf, float_type& a_sup, const float_type b_inf, const float_type b_sup, const float_type c_inf, const float_type c_sup)
{
...
__device__
void interval_mul_symmetric_c(float_type& a_inf, float_type& a_sup, const float_type b_inf, const float_type b_sup, const float_type c)
{
    if(-b_inf < b_sup)
    {
...
__device__
void interval_mul_const_c(float_type& a_inf, float_type& a_sup, const float_type b_inf, const float_type b_sup, const float_type c)
{
    if(c >= 0)
    {
        a_inf = mul_rd(b_inf, c);
...
__device__
void interval_mul_expr_coeff(float_type& res_inf, float_type& res_sup, const float_type inf, const float_type sup, const float_type inf_expr, const float_type sup_expr)
{
...
__device__
void interval_mul_cst_coeff(float_type& res_inf, float_type& res_sup, const float_type inf, const float_type sup, const float_type inf_expr, const float_type sup_expr)
{
...
__device__
void interval_mul_expr_coeff_const_expr(float_type& res_inf, float_type& res_sup, const float_type inf, const float_type sup, const float_type expr)
{
...
__device__
void interval_mul_cst_coeff_const_expr(float_type& res_inf, float_type& res_sup, const float_type inf, const float_type sup, const float_type expr)
{
