...
void meet_zones_mat(opt_zones_mat_t *oz, opt_zones_mat_t *oz1,
                    ...
                    bool destructive);
void sparse_join_zones_mat(opt_zones_mat_t *oo, opt_zones_mat_t *oo1,
                           opt_zones_mat_t *oo2, unsigned short int dim,
                           bool destructive);
...
void opt_zones_mat_addrem_dimensions(opt_zones_mat_t *dz, opt_zones_mat_t *sz,
                                     elina_dim_t *tdim, unsigned short int size,
                                     unsigned short int mult,
                                     unsigned short int dim, bool add);
void opt_zones_mat_permute(opt_zones_mat_t *dst, opt_zones_mat_t *src,
...
static inline bool check_trivial_relation_zones(double *m, unsigned short int i,
...
static inline void ini_unary_relation_zones(double *m, unsigned short int i,
                                            unsigned short int dim) {
  if (i >= dim) {
    return;
  }
...
// assumes i!=j
static inline void ini_binary_relation_zones(double *m, unsigned short int i,
                                             unsigned short int j,
                                             unsigned short int dim) {
  if ((i > dim) || (j > dim)) {
    return;
...
static inline void ini_relation_zones(double *m, unsigned short int i,
                                      unsigned short int j,
                                      unsigned short int dim) {
...
static inline void ini_comp_relations_zones(double *result, comp_list_t *cl1,
                                            comp_list_t *cl2,
                                            unsigned short int dim) {
  comp_t *c1 = cl1->head;
  while (c1 != NULL) {
...
static inline void ini_comp_elem_relation_zones(double *m, comp_list_t *cl1,
                                                unsigned short int j,
                                                unsigned short int dim) {
  comp_t *c1 = cl1->head;
  while (c1 != NULL) {
