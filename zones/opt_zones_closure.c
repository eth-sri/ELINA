...
******/
void strengthening_comp_zones(opt_zones_mat_t *oz, comp_list_t *cd,
                              unsigned short int dim, int sgn) {
  double *m = oz->mat;
...
bool strengthening_single_comp_zones(opt_zones_mat_t *oz, comp_list_t *cl,
...
void strengthening_incr_init_zones(opt_zones_mat_t *oz, array_comp_list_t *acl,
                                   char *map, unsigned short int dim) {
  unsigned short int num_comp = acl->size;
  unsigned short int i, j;
  double *m = oz->mat;
  /***********************
...
void strengthening_inter_comp_zones(opt_zones_mat_t *oz, array_comp_list_t *acl,
                                    char *map, unsigned short int dim) {
  unsigned short int num_comp = acl->size;
  unsigned short int i, j;
...
bool strengthening_intra_comp_zones(opt_zones_mat_t *oz,
                                    unsigned short int dim) {
  array_comp_list_t *acl = oz->acl;
  comp_list_t *cl = acl->head;
  double *m = oz->mat;
...
int calculate_zones_comp_sparsity(opt_zones_mat_t *oz, comp_list_t *cl,
                                  unsigned short int dim) {
  unsigned short int comp_size = cl->size;
  int count = 0;
  unsigned short int n = dim + 1;
...
void floyd_warshall_comp_zones(opt_zones_mat_t *oz, comp_list_t *cl,
                               unsigned short int dim) {
...
void compute_sparse_index(double *m, unsigned short int *ca,
                          ...
                          unsigned short int *index2, unsigned short int k,
                          unsigned short int dim) {
