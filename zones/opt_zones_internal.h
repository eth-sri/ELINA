...
static inline void zones_interval_of_bounds(elina_interval_t *i, double minf,
                                            double sup) {
...
static inline void opt_bound_of_scalar(opt_zones_internal_t *pr, double *r,
                                       elina_scalar_t *t, bool neg) {
  if (neg)
    elina_scalar_neg(t, t);
  if (!double_set_elina_scalar(r, t))
    pr->conv = true;
  if (neg)
    elina_scalar_neg(t, t);
}

static inline bool opt_bounds_of_coeff(opt_zones_internal_t *pr, double *minf,
                                       double *sup, elina_coeff_t c) {
  switch (c.discr) {
...
/**************
        Basic operators
*************/
opt_zones_t *opt_zones_alloc_internal(opt_zones_internal_t *pr,
                                      unsigned short int dim,
                                      unsigned short int intdim);
void opt_zones_fprint(FILE *stream, elina_manager_t *man, opt_zones_t *o,
                      char **name_of_dim);
...
opt_zones_t *opt_zones_top(elina_manager_t *man, unsigned short int intdim,
                           unsigned short int realdim);
opt_zones_t *opt_zones_bottom(elina_manager_t *man, unsigned short int intdim,
                              unsigned short int realdim);
...
opt_zones_t *opt_zones_closure(elina_manager_t *man, bool destructive,
                               opt_zones_t *o);
...
elina_tcons0_array_t opt_zones_to_tcons_array(elina_manager_t *man,
                                              opt_zones_t *o);
elina_interval_t **opt_zones_to_box(elina_manager_t *man, opt_zones_t *o);
elina_lincons0_array_t opt_zones_to_lincons_array(elina_manager_t *man,
                                                  opt_zones_t *o);
...
/*****************
        Nary operators
******************/
opt_zones_t *opt_zones_meet(elina_manager_t *man, bool destructive,
                            opt_zones_t *o1, opt_zones_t *o2);
opt_zones_t *opt_zones_join(elina_manager_t *man, bool destructive,
                            opt_zones_t *o1, opt_zones_t *o2);
opt_zones_t *opt_zones_widening(elina_manager_t *man, opt_zones_t *o1,
                                opt_zones_t *o2);

/********************
        Resize Operators
*********************/
opt_zones_t *opt_zones_forget_array(elina_manager_t *man, bool destructive,
                                    opt_zones_t *o, elina_dim_t *tdim, int size,
                                    bool project);
opt_zones_t *opt_zones_add_dimensions(elina_manager_t *man, bool destructive,
                                      opt_zones_t *o,
                                      elina_dimchange_t *dimchange,
                                      bool project);
opt_zones_t *opt_zones_remove_dimensions(elina_manager_t *man, bool destructive,
                                         opt_zones_t *o,
                                         elina_dimchange_t *dimchange);
opt_zones_t *opt_zones_permute_dimensions(elina_manager_t *man,
                                          bool destructive, opt_zones_t *o,
                                          elina_dimperm_t *permutation);
opt_zones_t *opt_zones_expand(elina_manager_t *man, bool destructive,
                              opt_zones_t *o, elina_dim_t dim, size_t n);
...
opt_zones_t *opt_zones_meet_tcons_array(elina_manager_t *man, bool destructive,
                                        opt_zones_t *o,
