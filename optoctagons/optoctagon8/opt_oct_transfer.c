			    ...
			    ap_tcons0_array_t* array)
{
  ...
  opt_oct_t *r = ap_generic_meet_intlinearize_tcons_array(man,destructive,o,array,
						  NUM_AP_SCALAR,
						  AP_LINEXPR_INTLINEAR,
						  &opt_oct_meet_lincons_array);

  //ap_lincons0_array_t arr1 = opt_oct_to_lincons_array(man,r);
  //ap_lincons0_array_fprint(stdout,&arr1,NULL);
