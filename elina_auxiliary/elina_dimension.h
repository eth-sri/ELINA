...
/* Initialize a dimchange2 structure by filling its fields with
   arguments */
static inline elina_dimchange2_t *
elina_dimchange2_alloc(elina_dimchange_t *add, elina_dimchange_t *remove);
...
static inline elina_dimchange2_t *
elina_dimchange2_alloc(elina_dimchange_t *add, elina_dimchange_t *remove) {
  elina_dimchange2_t *res =
      (elina_dimchange2_t *)malloc(sizeof(elina_dimchange2_t));
