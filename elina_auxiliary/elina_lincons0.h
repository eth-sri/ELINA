...
static inline elina_lincons0_t elina_lincons0_make(elina_constyp_t constyp,
...
static inline void elina_lincons0_clear(elina_lincons0_t *cons);
...
static inline void
elina_lincons0_add_dimensions_with(elina_lincons0_t *cons,
                                   elina_dimchange_t *dimchange);
static inline elina_lincons0_t
elina_lincons0_add_dimensions(elina_lincons0_t *cons,
                              elina_dimchange_t *dimchange);

static inline void
elina_lincons0_permute_dimensions_with(elina_lincons0_t *cons,
                                       elina_dimperm_t *perm);
static inline elina_lincons0_t
elina_lincons0_permute_dimensions(elina_lincons0_t *cons,
                                  elina_dimperm_t *perm);
...
elina_lincons0_add_dimensions(elina_lincons0_t *cons,
                              elina_dimchange_t *dimchange) {
  return elina_lincons0_make(
      cons->constyp, elina_linexpr0_add_dimensions(cons->linexpr0, dimchange),
      cons->scalar ? elina_scalar_alloc_set(cons->scalar) : NULL);
}
static inline void
elina_lincons0_permute_dimensions_with(elina_lincons0_t *cons,
...
elina_lincons0_permute_dimensions(elina_lincons0_t *cons,
                                  elina_dimperm_t *perm) {
  return elina_lincons0_make(
      cons->constyp, elina_linexpr0_permute_dimensions(cons->linexpr0, perm),
      cons->scalar ? elina_scalar_alloc_set(cons->scalar) : NULL);
}
