...
void test_meetjoin(unsigned short int dim, size_t nbcons, bool meet){
	...
	elina_linexpr0_set_coeff_scalar_int(lincons2.p[3].linexpr0,0,-1);
										        lincons2.p[4].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE,2);		elina_linexpr0_set_cst_scalar_int(lincons2.p[4].linexpr0,1);			elina_linexpr0_set_coeff_scalar_int(lincons2.p[4].linexpr0,0,-1);
	elina_linexpr0_set_coeff_scalar_int(lincons2.p[4].linexpr0,1,-1);
											lincons2.p[5].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE,2);		elina_linexpr0_set_cst_scalar_int(lincons2.p[5].linexpr0,0);			elina_linexpr0_set_coeff_scalar_int(lincons2.p[5].linexpr0,2,1);
