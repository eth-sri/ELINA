...
elina_lincons0_array_t generate_random_lincons0_array(unsigned short int dim,
  ...
  for (i = 0; i < nbcons / 3; i++) {
    ...
    elina_linexpr0_t *linexpr0 =
        elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, dim);
    cst = &linexpr0->cst;
    elina_scalar_set_to_int(cst->val.scalar, r, ELINA_SCALAR_MPQ);
    k = 0;
...
void test_meetjoin(unsigned short int dim, size_t nbcons, bool meet) {
  ...
  elina_lincons0_array_t lincons1 = elina_lincons0_array_make(6);
  lincons1.p[0].constyp = ELINA_CONS_SUPEQ;
  lincons1.p[1].constyp = ELINA_CONS_SUPEQ;
  lincons1.p[2].constyp = ELINA_CONS_SUPEQ;
  lincons1.p[3].constyp = ELINA_CONS_SUPEQ;
  lincons1.p[4].constyp = ELINA_CONS_SUPEQ;
  lincons1.p[5].constyp = ELINA_CONS_EQ;

  lincons1.p[0].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[0].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[0].linexpr0, 1, 1);

  lincons1.p[1].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[1].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[1].linexpr0, 1, -1);

  lincons1.p[2].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[2].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[2].linexpr0, 0, 1);

  lincons1.p[3].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[3].linexpr0, 0);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[3].linexpr0, 0, -1);

  lincons1.p[4].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 2);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[4].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[4].linexpr0, 0, -1);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[4].linexpr0, 1, -1);

  lincons1.p[5].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons1.p[5].linexpr0, 0);
  elina_linexpr0_set_coeff_scalar_int(lincons1.p[5].linexpr0, 2, 1);

  elina_lincons0_array_t lincons2 = elina_lincons0_array_make(6);
  lincons2.p[0].constyp = ELINA_CONS_SUPEQ;
  lincons2.p[1].constyp = ELINA_CONS_SUPEQ;
  lincons2.p[2].constyp = ELINA_CONS_SUPEQ;
  lincons2.p[3].constyp = ELINA_CONS_SUPEQ;
  lincons2.p[4].constyp = ELINA_CONS_SUPEQ;
  lincons2.p[5].constyp = ELINA_CONS_EQ;

  lincons2.p[0].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[0].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[0].linexpr0, 1, 1);
  // elina_lincons0_array_t lincons2 = elina_lincons0_array_make(6);

  lincons2.p[1].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[1].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[1].linexpr0, 1, -1);

  lincons2.p[2].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[2].linexpr0, 0);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[2].linexpr0, 0, 1);

  lincons2.p[3].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 1);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[3].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[3].linexpr0, 0, -1);
  lincons2.p[4].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 2);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[4].linexpr0, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[4].linexpr0, 0, -1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[4].linexpr0, 1, -1);
  lincons2.p[5].linexpr0 = elina_linexpr0_alloc(ELINA_LINEXPR_SPARSE, 2);
  elina_linexpr0_set_cst_scalar_int(lincons2.p[5].linexpr0, 0);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[5].linexpr0, 2, 1);
  elina_linexpr0_set_coeff_scalar_int(lincons2.p[5].linexpr0, 0, -1);

  elina_manager_t *man = opt_pk_manager_alloc(false);
  // generate first input
  opt_pk_array_t *oa1 = opt_pk_top(man, 3, 0);

  // meet with constraints
  opt_pk_array_t *oa2 = opt_pk_meet_lincons_array(man, false, oa1, &lincons1);

  // generate second input
  opt_pk_array_t *oa3 = opt_pk_top(man, 3, 0);
...
void test_assign(unsigned short int dim, size_t nbcons) {
  ...
  elina_linexpr0_t **expr_array =
      (elina_linexpr0_t **)malloc(sizeof(elina_linexpr0_t *));
  ...
  // assign;
  opt_pk_array_t *oa3 =
      opt_pk_assign_linexpr_array(man, false, oa2, tdim, expr_array, 1, NULL);
...
void test_assign_array(unsigned short int dim, size_t nbcons) {
  ...
  opt_pk_array_t *oa3 =
      opt_pk_assign_linexpr_array(man, false, oa2, tdim, expr_array, 5, NULL);
...
int main(int argc, char **argv) {
  if (argc < 3) {
    printf("The test requires two positive integers: (a) Number of variables "
           "and (b) Number of constraints");
    return 0;
  }
