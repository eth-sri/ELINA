                                  ...
                                  if (need_refine) {
                                    ...
                                    poly[num_comp]->satC = opt_satmat_alloc(
                                        ...
                                        opt_bitindex_size(
                                            poly[num_comp]->C->nbrows));
                                    combine_satmat(
                                        opk, poly[num_comp], clb_copy->size,
