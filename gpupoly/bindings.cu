...
struct SplashScreen
{
	SplashScreen()
	{
		std::cout << "GPUPoly GPU " << VERSION_MAJOR << "." << VERSION_MINOR << "." << VERSION_PATCH;
		...
		std::cout << " Debug";
#endif
		std::cout << " (built " << __DATE__ << " " << __TIME__ << ") - Copyright (C) 2020 Francois Serre" << std::endl;
		std::cout << "This program comes with ABSOLUTELY NO WARRANTY. This is free software, and you are welcome to redistribute it and to modify it under the terms of the GNU GPLv3+ <http://gnu.org/licenses/gpl.html>." << std::endl << std::endl;
	}
} ss;
