...
class Network:
    if os.name == 'nt':
        ...
        #os.add_dll_directory("/home/mark/Projects/ERAN/eran/ELINA/gpupoly")
        os.add_dll_directory("/usr/local/cuda/bin")
        os.add_dll_directory("/home/mark/Projects/ERAN/eran/ELINA/gpupoly")
        _lib = ctypes.cdll.LoadLibrary(ctypes.util.find_library('gpupoly'))
    else:
        # _lib=ctypes.cdll.LoadLibrary('/home/mark/Projects/ERAN/eran/ELINA/gpupoly/dpGPUlib.so.0.10')
