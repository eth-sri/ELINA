...
void substitute_spatial_heuristic(double *lb, double *ub, double *sub_lb,
            ...
            while (change) {
              ...
              for (size_t i = 0; i < fp->spatial_constraints_size; ++i) {
                ...
                if (expr_coeffs[s_idx] != 0 && expr_coeffs[s_nbr] != 0) {
                  ...
                  substitute_spatial_heuristic(
                      &lb_org, &ub_org, &tmp1, &tmp2, expr_coeffs[s_idx],
                      fp->input_inf[idx], fp->input_sup[idx],
