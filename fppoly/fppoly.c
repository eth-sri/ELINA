...
double apply_s_curve_lexpr(fppoly_internal_t *pr, expr_t **lexpr_p, neuron_t * neuron, bool is_sigmoid){
	...
	if(boxify){
		...
		elina_double_interval_mul_cst_coeff(pr, &lexpr->inf_cst, &lexpr->sup_cst, intercept_inf, intercept_sup, lexpr->inf_cst, lexpr->sup_cst );
...
double apply_s_curve_uexpr(fppoly_internal_t *pr, expr_t **uexpr_p, neuron_t * neuron, bool is_sigmoid){
	...
	if(boxify){
		...
		elina_double_interval_mul_cst_coeff(pr, &uexpr->inf_cst, &uexpr->sup_cst, intercept_inf, intercept_sup, uexpr->inf_cst, uexpr->sup_cst );
